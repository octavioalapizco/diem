...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'C:\\xampp\\htdocs\\diem-5.1.3\\Acme\\log/front_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  {
    $class = sfConfig::get('sf_factory_i18n', 'dmFrontI18n');
    $cache = new dmMetaCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\xampp\\htdocs\\diem-5.1.3\\Acme\\cache\\front\\dev\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'C:\\xampp\\htdocs\\diem-5.1.3\\Acme\\apps\\front/i18n',
));
  ...
  $class = sfConfig::get('sf_factory_controller', 'dmFrontWebController');
   $this->factories['controller'] = new $class($this);
  $class = sfConfig::get('sf_factory_request', 'dmWebRequest');
  ...
  $class = sfConfig::get('sf_factory_response', 'dmWebResponse');
  ...
  $class = sfConfig::get('sf_factory_routing', 'dmFrontRouting');
      $cache = new dmMetaCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\xampp\\htdocs\\diem-5.1.3\\Acme\\cache\\front\\dev\\config/routing',
  'lifetime' => 31556926,
  'prefix' => 'C:\\xampp\\htdocs\\diem-5.1.3\\Acme\\apps\\front/routing',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  {
    $class = sfConfig::get('sf_factory_view_cache', 'dmMetaCache');
    $cache = new $class(sfConfig::get('sf_factory_view_cache_parameters', array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\xampp\\htdocs\\diem-5.1.3\\Acme\\cache\\front\\dev\\template',
  'lifetime' => 86400,
  'prefix' => 'C:\\xampp\\htdocs\\diem-5.1.3\\Acme\\apps\\front/template',
)));
